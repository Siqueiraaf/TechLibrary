...
using TechLibrary.Api.Infrastructure.Security.Token.Acess;
...
public class RegisterUserUseCase
{
    public ResponseRegisteredUserJson Execute(RequestUserJson request)
    {
        ...
        var tokenGenerator = new JwrTokenGenerator();
    ...
    {
        var validadator = new RegisterUserValidador();

        var result = validadator.Validate(request);
